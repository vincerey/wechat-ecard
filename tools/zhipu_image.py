...
PROMPTS = {
    "cover.png": (
        "手机竖屏电子贺卡封面插画，小王子童话风格：一位金色短发、围着米色围巾、"
        "穿着淡蓝色衣服的小男孩，站在一颗小小的星球上，双手温柔地捧着一朵盛开的红玫瑰，"
        "微微低头看着玫瑰，神情温暖。背景是深蓝色夜空、闪烁的星星和一弯金色的月亮，"
        "整体梦幻唯美、可爱治愈。柔和的水彩插画风格，光线温柔。"
        "构图：小王子与玫瑰放在画面下半部分，上半部分留出较暗的星空区域方便叠加标题文字。"
        "不要出现任何文字。"
    ),
    "inner.png": (
